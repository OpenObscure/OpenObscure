...
- [What Is OpenObscure?](what-is-openobscure.md) — the problem, what it intercepts, what it doesn't do
- [Deployment Models](deployment-models.md) — Gateway (sidecar proxy) vs Embedded (native library)
