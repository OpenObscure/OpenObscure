# OpenObscure Embedded (Mobile) Demo
...
UniFFI auto-generates idiomatic wrappers from the Rust API. All functions below are available after running `scripts/generate_bindings.sh`.
...
See [GATEWAY_DEMO.md](GATEWAY_DEMO.md) for these Gateway-specific features.
