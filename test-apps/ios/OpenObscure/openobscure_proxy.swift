...
#if canImport(openobscure_proxyFFI)
import openobscure_proxyFFI
#endif
...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_openobscure_proxy_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_openobscure_proxy_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsureOpenobscureProxyInitialized()
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_openobscure_proxy_uniffi_contract_version()
...
public func uniffiEnsureOpenobscureProxyInitialized() {
