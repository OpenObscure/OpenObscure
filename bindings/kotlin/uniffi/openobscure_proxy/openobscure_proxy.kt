...
package uniffi.openobscure_proxy
   ...
   internal fun setValue(other: RustBuffer) {
    ...
    companion object {
        internal fun alloc(size: ULong = 0UL) = uniffiRustCall() { status ->
            ...
            UniffiLib.INSTANCE.ffi_openobscure_proxy_rustbuffer_alloc(size.toLong(), status)
        }.also {
            if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = uniffiRustCall() { status ->
            UniffiLib.INSTANCE.ffi_openobscure_proxy_rustbuffer_free(buf, status)
        }
    }
...
internal interface UniffiLib : Library {
    companion object {
        internal val INSTANCE: UniffiLib by lazy {
            val componentName = "openobscure_proxy"
            // For large crates we prevent `MethodTooLargeException` (see #2340)
            // N.B. the name of the extension is very misleading, since it is 
            // rather `InterfaceTooLargeException`, caused by too many methods 
            // in the interface for large crates.
...
fun ffi_openobscure_proxy_rustbuffer_from_bytes(`bytes`: ForeignBytes.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
fun ffi_openobscure_proxy_rustbuffer_free(`buf`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): Unit
fun ffi_openobscure_proxy_rustbuffer_reserve(`buf`: RustBuffer.ByValue,`additional`: Long,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
fun ffi_openobscure_proxy_rust_future_poll_u8(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_cancel_u8(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_free_u8(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_complete_u8(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
): Byte
fun ffi_openobscure_proxy_rust_future_poll_i8(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_cancel_i8(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_free_i8(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_complete_i8(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
): Byte
fun ffi_openobscure_proxy_rust_future_poll_u16(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_cancel_u16(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_free_u16(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_complete_u16(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
): Short
fun ffi_openobscure_proxy_rust_future_poll_i16(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_cancel_i16(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_free_i16(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_complete_i16(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
): Short
fun ffi_openobscure_proxy_rust_future_poll_u32(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_cancel_u32(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_free_u32(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_complete_u32(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
): Int
fun ffi_openobscure_proxy_rust_future_poll_i32(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_cancel_i32(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_free_i32(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_complete_i32(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
): Int
fun ffi_openobscure_proxy_rust_future_poll_u64(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_cancel_u64(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_free_u64(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_complete_u64(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
): Long
fun ffi_openobscure_proxy_rust_future_poll_i64(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_cancel_i64(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_free_i64(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_complete_i64(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
): Long
fun ffi_openobscure_proxy_rust_future_poll_f32(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_cancel_f32(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_free_f32(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_complete_f32(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
): Float
fun ffi_openobscure_proxy_rust_future_poll_f64(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_cancel_f64(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_free_f64(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_complete_f64(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
): Double
fun ffi_openobscure_proxy_rust_future_poll_pointer(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_cancel_pointer(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_free_pointer(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_complete_pointer(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
): Pointer
fun ffi_openobscure_proxy_rust_future_poll_rust_buffer(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_cancel_rust_buffer(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_free_rust_buffer(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_complete_rust_buffer(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
fun ffi_openobscure_proxy_rust_future_poll_void(`handle`: Long,`callback`: UniffiRustFutureContinuationCallback,`callbackData`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_cancel_void(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_free_void(`handle`: Long,
): Unit
fun ffi_openobscure_proxy_rust_future_complete_void(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
): Unit
...
private fun uniffiCheckContractApiVersion(lib: IntegrityCheckingUniffiLib) {
    ...
    val scaffolding_contract_version = lib.ffi_openobscure_proxy_uniffi_contract_version()
 ...
 * @suppress
 */
public object FfiConverterTypeMobileStatsFFI: FfiConverterRustBuffer<MobileStatsFfi> {
    override fun read(buf: ByteBuffer): MobileStatsFfi {
        return MobileStatsFfi(
    ...
    override fun allocationSize(value: MobileStatsFfi) = (
            FfiConverterULong.allocationSize(value.`totalPiiFound`) +
            FfiConverterULong.allocationSize(value.`totalImagesProcessed`) +
            FfiConverterString.allocationSize(value.`scannerMode`) +
            FfiConverterBoolean.allocationSize(value.`imagePipelineAvailable`) +
            FfiConverterString.allocationSize(value.`deviceTier`)
    )

    override fun write(value: MobileStatsFfi, buf: ByteBuffer) {
            FfiConverterULong.write(value.`totalPiiFound`, buf)
            FfiConverterULong.write(value.`totalImagesProcessed`, buf)
            FfiConverterString.write(value.`scannerMode`, buf)
            FfiConverterBoolean.write(value.`imagePipelineAvailable`, buf)
            FfiConverterString.write(value.`deviceTier`, buf)
    }
}
 ...
 * @suppress
 */
public object FfiConverterTypeSanitizeResultFFI: FfiConverterRustBuffer<SanitizeResultFfi> {
    override fun read(buf: ByteBuffer): SanitizeResultFfi {
        return SanitizeResultFfi(
            FfiConverterString.read(buf),
    ...
    override fun allocationSize(value: SanitizeResultFfi) = (
            FfiConverterString.allocationSize(value.`sanitizedText`) +
            FfiConverterUInt.allocationSize(value.`piiCount`) +
            FfiConverterSequenceString.allocationSize(value.`categories`) +
            FfiConverterString.allocationSize(value.`mappingJson`)
    )

    override fun write(value: SanitizeResultFfi, buf: ByteBuffer) {
            FfiConverterString.write(value.`sanitizedText`, buf)
...
public object FfiConverterTypeMobileBindingError : FfiConverterRustBuffer<MobileBindingException> {
    override fun read(buf: ByteBuffer): MobileBindingException {
        ...
        return when(buf.getInt()) {
            ...
            2 -> MobileBindingException.InvalidKey(
                FfiConverterString.read(buf),
                )
            3 -> MobileBindingException.Init(
                FfiConverterString.read(buf),
                )
            4 -> MobileBindingException.Processing(
                FfiConverterString.read(buf),
                )
    ...
    override fun allocationSize(value: MobileBindingException): ULong {
        return when(value) {
            is MobileBindingException.Config -> (
            ...
            is MobileBindingException.Init -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.v1)
            )
            is MobileBindingException.Processing -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.v1)
            )
